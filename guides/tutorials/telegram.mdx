...
<CardGroup cols={2}>
  <Card title="Smart Routing" icon="route" href="/integrations/telegram/routing">
    Set up automatic content routing
  </Card>
  <Card title="Voice Features" icon="microphone" href="/features/voice">

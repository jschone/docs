...
<Steps>
  ...
  <Step title="Speak Naturally">
    ...
    - _"Spent forty-five dollars on groceries at Whole Foods"_
    - _"Ran 5k in 28 minutes this morning"_
    - _"Met with Sarah about Q3 planning, went well"_
  </Step>
...
<AccordionGroup>
  <Accordion title="Example: Expense Tracker">
    **You say:** _"Lunch with the team, sixty-two dollars, put it under meals"_
  ...
  <Accordion title="Example: Workout Log">
    **You say:** _"Did upper body today, bench pressed 185 for 3 sets of 8"_
  ...
  <Accordion title="Example: Meeting Notes">
    **You say:** _"One-on-one with David, discussed promotion timeline, follow up next week"_
...
<Steps>
  ...
  <Step title="Listen for the Prompt">
    Peanuts speaks: _"Ready to log. What would you like to add?"_
  </Step>
...
<Steps>
  ...
  <Step title="Ask Your Question">
    ...
    - _"What's my workout streak?"_
    - _"Show my meetings from last week"_
  </Step>
...
<CardGroup cols={2}>
  <Card title="Create Your First Helper" icon="wand-magic-sparkles" href="/tutorials/create-your-first-helper">
    Start tracking before using voice
  </Card>
  <Card title="Connect Telegram" icon="paper-plane" href="/tutorials/connect-telegram">
    Voice messages via Telegram
  </Card>
  <Card title="Credits & Usage" icon="coins" href="/features/credits">

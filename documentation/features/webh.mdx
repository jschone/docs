---
title: "EXPERIMENTAL! Outgoing Webhooks "
...
<CardGroup cols={2}>
  ...
  <Card title="Secure Signatures" icon="shield-check">
    Optional HMAC signatures verify that requests come from Peanuts
  </Card>
  <Card title="Delivery Tracking" icon="list-check">
...
<Steps>
  ...
  <Step title="Expand Webhook Settings">
...
<Frame>
  ![Webhook configuration interface](/images/integrations/webhook-setup.png)
</Frame>
